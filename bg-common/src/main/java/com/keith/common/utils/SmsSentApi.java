...
public class SmsSentApi {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        String apikey = "de501d4751640f669566b5c9a8621bf1";

        //修改为您要发送的手机号
//        String mobile = URLEncoder.encode("13173622531",ENCODING);
        String mobile = URLEncoder.encode("15057192416",ENCODING);

        /**************** 查账户信息调用示例 *****************/
        System.out.println(SmsSentApi.getUserInfo(apikey));

        /**************** 使用智能匹配模版接口发短信(推荐) *****************/
        //设置您要发送的内容(内容必须和某个模板匹配。以下例子匹配的是系统提供的1号模板）
        String text = "【云片网】您的验证码是123456";
        //发短信调用示例
//        System.out.println(SmsSentApi.sendSms(apikey, text, mobile));
        ...
        System.out.println(SmsSentApi.tplSendSms(apikey, tpl_id, tpl_value, mobile));
