...
public class WxPay {
    ...
    /**
     * 提现到银行卡
     * @param entBankPayInfo
     * @return
     * @throws WxPayException
     */
    public static EntPayBankResult entBankPay(EntBankPayInfo entBankPayInfo) throws WxPayException {
        EntPayBankRequest request=new EntPayBankRequest();
        request.setPartnerTradeNo(entBankPayInfo.getPartnerTradeNo());
        request.setEncBankNo(entBankPayInfo.getEncBankNo());
        request.setEncTrueName(entBankPayInfo.getEncTrueName());
        request.setBankCode(entBankPayInfo.getBankCode());
        request.setAmount(entBankPayInfo.getAmount());
        request.setDescription(entBankPayInfo.getDescription());
