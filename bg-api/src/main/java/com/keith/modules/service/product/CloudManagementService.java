...
//    void buyCloud(Long userMemberId,List<BuyCloudProSelect> products);
    ...
    /**计算该商品该规格回收价格---*/
    List<Object> countRepoPrice(Long productId, Long userMemberId);
    /**生成订单*/
    Map<String, Object> createCloudOrder(BuyCloudProSelect buyCloudProSelect,Long userMemberId,String orders);
