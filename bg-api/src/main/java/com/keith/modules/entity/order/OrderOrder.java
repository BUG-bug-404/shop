...
public class OrderOrder implements Serializable {
	...
	@ApiModelProperty(value = "待支付-尾款")
	@TableField(exist = false)
	private String needPay;

	@ApiModelProperty(value = "0已到支付时间1未到支付时间")
	@TableField(exist = false)
	private Integer startPayStatus;

	@ApiModelProperty(value = "是否已过截止时间0已到支付截止时间1未到支付截止时间")
	@TableField(exist = false)
	private Integer endPayStatus;

	@ApiModelProperty(value = "订单开始支付时间")
	@TableField(exist = false)
	private String startTime;

	@ApiModelProperty(value = "订单支付截止时间")
	@TableField(exist = false)
	private String endTime;

	@ApiModelProperty(value = "订单-商品-规格-详情")
	@TableField(exist = false)
